...
export const RecordReturnDialog: React.FC<RecordReturnDialogProps> = ({ open, onOpenChange, supplyOrder }) => {
  ...
  const handleSubmit = () => {
    try {
      ...
      const gasSalesBalance = paymentTotals.subtotal - totalExpenses;
      const driverDebtChange = Math.max(0, gasSalesBalance - totalPaid);
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100">
              <div className="flex flex-wrap gap-4">
                ...
                <div className="bg-indigo-600 px-4 py-2 rounded-lg shadow-md">
                  <div className="text-[10px] uppercase font-bold text-indigo-200">Net à Payer</div>
            ...
            <DialogContent className="sm:max-w-md">
              ...
              <div className="grid gap-6 py-4">
                <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-100 flex justify-between items-center">
                  <span className="font-bold text-indigo-900">Total Net à Payer:</span>
                ...
                <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-2xl font-bold text-orange-600">{Math.max(0, (paymentTotals.subtotal - totalExpenses) - (parseFloat(paymentCashAmount) || 0) - (parseFloat(paymentCheckAmount) || 0) - (parseFloat(paymentMygazAmount) || 0)).toFixed(2)} DH</span>
                  </div>
